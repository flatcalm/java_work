...
/*
 ...
 2. 매개변수는 여러 개 존재할 수 있지만, 반환값은 오직 1개만 
 	존재해야 합니다.
 ...
 5. 반환값이 있는 메서드는 호출문 자체가 하나의 값으로 처리될 수 있기 때문데 
 ...
 7. 이 때는(return을 생략하고 싶을 때) 반환유형을 메서드를 선언할 때 비워두지 마시고 
...
//		double[] result1 = calcArrayTotal(new int[] {57, 89, 78, 91, 93, 47});
		
		System.out.printf("합계 : %.0f%n", result[0]);
		System.out.printf("평균 : %.2f%n", result[1]);
//		System.out.printf("합계 : %.d%n", (int) result1[0]);
//		System.out.printf("평균 : %.2f%n", result1[1]);
