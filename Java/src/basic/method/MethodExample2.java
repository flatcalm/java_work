...
/*
 # 매개 변수 (parameter, argument)
 	...
 	1. 매개 변수는 메서드를 호출할 때, 메서드 실행에 필요한 값들을
 	...
 	4. 매개 변수의 이름을 지을 때는 호출자가 선언부로 돌아와서 
 		매개값을 확인하지 않게, 어떠한 값을 담는 변수인지 
 		그 뜻을 알기 쉽게 지어주면 서로에게 좋습니다.
 	
 	5. 매개 변수를 하나도 선언하지 않을수도 있습니다. 
 		이 때는 메서드의 선언부에 () 내부를 비워둡니다. 
...
public class MethodExample2 {
	...
	// 콤마로 나열되어 들어오는 여려개의 값을 배열로 묶어서 내부로 전달합니다. 
