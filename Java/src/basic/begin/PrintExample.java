...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		/*
		 # 포맷팅 서식 문자 종류 -> printf에서만 사용
		 	%d : 부호가 있는 정수 데이터 (decimal)
		 	%f : 실수 데이터 (floation point)
		 	%s : 문자열 (String)
		 	%n : 줄 개행 명령
		 	
		 # 탈출 코드 (escape code) -> printf에만 동작하는 게 아니에요. (모든 함수에서 사용 가능)
		 	- 반드시 따옴표 내에 위치해야 합니다. 
		 	- 문자열 내에서 특정 명령을 내리고 싶을 때 싸용하는 특수 기호입니다. 
		 	\n : 줄 개행 명령 
		 	\t : 가로  공백 (스페이스 4칸(탭 한번)) 
		 */
		...
		double rate = 64.126;
		System.out.printf("합격률은 %.2f%%입니다.%n", rate);
