...
//		int age = 40; ( X ) 
		...
		// 2. 식별자 이름은 숫자로 지정하거나 숫자로 시작하시면 안 됩니다.
//		int 700 = 365; ( X )
//		int 7number = 7; ( X )
		int number7111 = 7;
		int num7ber = 7;
...
//		int my birth day = 19921013; ( X )
		...
		// 4. 식별자 이름에 쓸 수 있는 특수 문자는 밑줄(_), 달러 기호($) 
		//	뿐입니다. 하지만 사용을 권장하지는 않습니다.
		//	저 특수 문자들은 사용하기로 약속한 곳이 지정되어 있습니다.
		String $hello_ = "안녕";
...
//		String class = "클래스"; ( X )
		...
		// 앞글자가 대문자로 시작하면 클래스 (관례)
		// 앞글자가 소문자로 시작하면 메소드, 변수, 키워드 (관례)
		// 변수 이름을 너무 대충 지으면 코드가 길어질수록 무슨 변수였는지 알기 힘듬
